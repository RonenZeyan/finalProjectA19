...
export default function UserNewMissions(){
    ...
    useEffect(()=>{
        axios.get(`https://final-project-a19-api.vercel.app/newUserMissions/${userID}`)
        .then(
            (Missions) =>{
    ...
    const handleOnClickAcceptMissionButton = (mission) =>
    {
        ...
        if(isConfirmed)
        {
            axios.post(`https://final-project-a19-api.vercel.app/acceptMission/${mission._id}`)
            .then(res=>
                {
    ...
    return (
        ...
        <div className="user_home h-[100vh] content flex flex-col justify-center items-center">     
            <h1 className="font-bold text-3xl text-center py-3 ">New Missions</h1>
