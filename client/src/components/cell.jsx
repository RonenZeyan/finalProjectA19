    ...
    return (
        <td className='border border-slate-300 font-bold px-5'>
            {prop.header ? (
                ...
                <img className='m-auto' src={prop.data?`http://localhost:3001\\${prop.data}`:"\images\iconMan.png"} alt="UserIMG" style={{width: '50px', height: '50px',border:'solid 2px grey',borderRadius:'50%'}} />
            ) : (
                prop.data
            )}
        </td>
