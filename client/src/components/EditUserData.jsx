...
//display the data of user 
    ...
    return (
        <div className="user_home h-[100vh] content flex flex-col justify-center items-center py-7">
            <img className='rounded-full bg-white w-[200px] h-[200px] border border-black' src={userData.image?`https://final-project-a19-api.vercel.app/${userData.image}`:"/images/iconMan.png"}  alt="mypicture" />
